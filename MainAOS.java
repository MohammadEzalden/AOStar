...
public class MainAOS {
    ...
    public static void main(String[] arrs){
        ...
        nop.add(p1);nop.add(p2);
        Operators op1=new Operators(true,5,p0,nop);

        nop=new ArrayList<>();nop.add(p3);
        Operators op2=new Operators(false,19,p0,nop);

        nop=new ArrayList<>();nop.add(p4);nop.add(p5);
        Operators op3=new Operators(true,8,p0,nop);

        nop=new ArrayList<>();nop.add(p15);nop.add(p10);
        Operators op4=new Operators(true,5,p2,nop);

        nop=new ArrayList<>();nop.add(p6);nop.add(p7);
        Operators op5=new Operators(true,20,p3,nop);

        nop=new ArrayList<>();nop.add(p8);nop.add(p9);
        Operators op6=new Operators(true,10,p3,nop);

        nop=new ArrayList<>();nop.add(p10);
        Operators op7=new Operators(false,10,p4,nop);

        nop=new ArrayList<>();nop.add(p11);nop.add(p12);
        Operators op8=new Operators(true,20,p4,nop);

        nop=new ArrayList<>();nop.add(p13);nop.add(p14);nop.add(p6);
        Operators op9=new Operators(true,45,p10,nop);

        ArrayList<Operators>operators=new ArrayList<>();
        operators.add(op1);operators.add(op2);operators.add(op3);
        p0.operators=operators;

        operators=new ArrayList<>();operators.add(op4);
        p2.operators=operators;

        operators=new ArrayList<>();operators.add(op5);operators.add(op6);
        p3.operators=operators;

        operators=new ArrayList<>();operators.add(op7);operators.add(op8);
        p4.operators=operators;

        operators=new ArrayList<>();operators.add(op9);
        p10.operators=operators;



        System.out.println(AO.algorithmAO(p0));
